...
- Resolva os exercícios **na ordem**, sem consultar solução pronta.
- Sempre que possível, escreva o código primeiro no papel ou em um editor simples, e só depois rode no PHP para conferir.
- Preste atenção não apenas em fazer o código funcionar, mas em conseguir **explicar por que ele funciona**.

Bons estudos!

---

## Exercício 1 — Comparando valores (feito)
...
## Exercício 2 — Contagem com `for` (feito)
...
## Exercício 3 — Função com retorno (feito)
...
## Exercício 4 — Categorizando com `switch` (feito)
